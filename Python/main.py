...
from PyQt5.QtWidgets import QMainWindow, QGridLayout, QWidget, QComboBox, QApplication, QLineEdit, QLabel, QSlider, QSpinBox, QDoubleSpinBox
import sys
import numpy as np
...
class PrettyWidget(QMainWindow):
    ...
    def initUI(self):
        version = 'U4Opt: GUI for the undulator optimization ver. 0.001'
        #self.floating = '.2f'
        ...
        grid.addWidget(toolbar, 6,0,1,7)
        ...
        grid.addWidget(QLabel('PPMz/period:'), 4, 5)
    ...
    def update_beam_energy(self):
        self.E_e = self.beam_energy.value()
        self.calc()
